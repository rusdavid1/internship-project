 ...
 */
final class Version20220317145906 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE cnp cnp CHAR(13) NOT NULL, CHANGE roles roles JSON NOT NULL');
    }
