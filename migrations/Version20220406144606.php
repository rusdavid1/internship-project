 ...
 */
final class Version20220406144606 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD phone_number VARCHAR(255) NOT NULL, DROP deletedAt');
