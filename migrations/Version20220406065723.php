 ...
 */
final class Version20220406065723 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD deletedAt DATETIME DEFAULT NULL, DROP phone_number');
    }
