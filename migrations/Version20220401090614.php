 ...
 */
final class Version20220401090614 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP reset_token, CHANGE reset_token_created_at deletedAt DATETIME DEFAULT NULL');
    }
