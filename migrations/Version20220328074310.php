 ...
 */
final class Version20220328074310 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE api_token api_token BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
    }
